...
Feature:Creation of Projects and validation of Project Setting Pop Up
  ...
  @Smoke @Reg @Positive @CRP-Test1 @TC8
  ...
  @Smoke @Reg @Positive @CRP-Test3 @TC10
  ...
  @Smoke @Reg @Positive @CRP-Test5 @TC12
  ...
  @Smoke @Reg @Positive @CRP-Test6 @TC13
  ...
  @Smoke @Reg @Positive @CRP-Test7 @TC14
  ...
  @Smoke @Reg @Negative @CRP-Test8 @TC15
  ...
  @Smoke @Reg @Negative @CRP-Test9 @TC16
  ...
  @Smoke @Reg @Negative @CRP-Test10 @TC17
