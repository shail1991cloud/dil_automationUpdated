...
Feature: User is able to create Delta Source and Destination
  ...
  @Smoke @Reg @Positive @Delta1 @TC25
  ...
  @Smoke @Reg @Positive @@Delta2 @TC26
  ...
  @Smoke @Reg @Positive @@Delta3 @TC27
  ...
  @Smoke @Reg @Positive @Delta4 @TC28
  ...
  @Smoke @Reg @Positive @Delta5 @TC29
  ...
  @Smoke @Reg @Positive @Delta6 @TC30
